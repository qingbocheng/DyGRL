...
class Config():
    def __init__(self, seed_num=2022, current_date=None):
        ...
        self.benchmark_algo = 'MASA-mlp' # Algorithm: 'MASA-dc', 'MASA-mlp', 'MASA-lstm', 'TD3-Profit', 'TD3-PR', 'TD3-SR', 'CRP', (Please implement firstly before running 'EG', 'OLMAR', 'PAMR', 'CORN', 'RMR', 'EIIE', 'PPN', 'RAT')
        self.market_name = 'CSI300' # Financial Index: 'DJIA', 'SP500', 'CSI300','CRP'
        self.topK = 300 # Number of assets in a portfolio (10, 20, 30)
        ...
        self.csp = 'csi300'
        self.days = 1
        self.device = th.device("cuda:0") #th.device("cuda:0") # th.device("cpu")
        if 'TD3' in self.benchmark_algo:
            ...
            # self.mode = 'SACcontroller' # For the proposed MASA framework
        ...
        self.enable_market_observer = False # True if enabling the market observer.
        self.enable_market_observer_CSP = False # True if enabling the market observer.
        ...
        #self.dataDir = '/root/quant-ml-qlib/MASA/data'
